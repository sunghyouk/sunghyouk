...
dap.adapters.python = {
    type = 'executable';
    command = os.getenv('HOME') .. '/Users/sunghyoukchoi/opt/anaconda3/bin/python3';
...
dap.configurations.python = {
    {
        ...
        program = "${file}";
        pythonPath = function()
            return '/Users/sunghyoukchoi/opt/anaconda3/bin/python3'
        end;
    },
}

require('dap-python').setup('/Users/sunghyoukchoi/opt/anaconda3/bin/python3')
